...
createBox: function(data) {
    ...
    //Setting box name
    box.update('<div class="application_rounded multiSelect_border ">&nbsp;</div><div class="multiSelect_text">' + unescape(data.get('text')).gsub(' ', '&nbsp;') + '</div>');
    var closeButton = new Element('div', {
        'class': 'multiSelect_closeButton application_rounded'
    }).update("<div class='application_currentSelection multiSelect_alignClose'></div>");
...
*/
addBoxByData: function(indexEmp) {
