    ...
    */
    onClick: function(event) {
        ...
        if (this.elementClicked.identify().include('treeHandler_text') || (!Object.isEmpty(parentElementClicked) &&
            ...
            document.fire('EWS:treeHandler_textClicked', $H({
            ...
            if (!this.visitedNodes.get(this.elementClicked.identify())) {
                ...
                if (children.getAttribute('childs')) {
                    //if we have readed the xml
                    document.fire('EWS:treeHandler_GiveMeXml', this.clickedParent);
                }
    ...
    insertTreeNode: function(xmlNode, parentId, hasChild) {
        ...
        if (hasChild == true) {
            newNodeElem.update(new Element('span', {
                'class': 'application_verticalR_arrow treeHandler_align_verticalArrow'
            }).insert('&nbsp;'));
        ...
        if (this.checkBoxes) {
            if (!hasChild || checkRoot == 'X') {
                ...
                {
                    'type': 'checkbox',
                    className: 'treeHandler_input treeHandler_input_' + parentId,
                    'id': 'treeHandler_input_' + nodeId + '_' + this.ident.identify()
                }).observe('click', this.checkBoxClicked.bind(this));
