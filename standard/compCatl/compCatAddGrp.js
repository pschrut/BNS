var COMP_CATL_ACG = Class.create(getContentDisplayer, {
    ...
    */
    run: function($super, args) {
        ...
        var buttonsHandlers = $H({
            APP_CQK_GROUP_SAVE: function() { this.saveRequest('APP_CQK_GROUP_SAVE'); } .bind(this),
            cancel: function() {
    ...
    */
    ...
    checkMandatory: function(event) {
        ...
        if (flag == 0) {
            this.ButtonGenericApp2.disable("COMP_CATL_ACG_APP_CQK_SAVE");
        }
        else {
            this.ButtonGenericApp2.enable("COMP_CATL_ACG_APP_CQK_SAVE");
        }
    },
    /*
