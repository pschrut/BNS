var SendDocument_admin = new Class.create(Application,

{
    initialize: function($super, args) {
        ...
        this.getEmpListHandlerBinding = this.getEmpListHandler.bindAsEventListener(this);

        this.empSelectedHandlerBinding = this.empSelectedHandler.bindAsEventListener(this);
        ...
        document.observe('EWS:sendDocEmpSelected', this.empSelectedHandlerBinding);
    ...
    buildEmployeesList: function(json) {
        ...
        this.empSelectedHandler();
    },


    empSelectedHandler: function(evt) {
    ...
    buildScreen: function() {
		...
		'<span class="fieldDispFloatLeft">' + global.getLabel('DML_FIND_EMPLOYEE') + ' : </span>' +
		'<div class="fieldDispFloatLeft" id="send_document_emp_autocompleter" style="margin-left:10px;"></div>' +
		'</div>' +


		'<div style="width:99%;float:left;text-align:left;margin-bottom:10px">' +
			global.getLabel('DML_CURRENTLY_SELECTED_EMPLOYEE') + ' : <b></b>' +
		'</div>' +
        ...
        this.empAutocompleter = new JSONAutocompleter('send_document_emp_autocompleter', {
            showEverythingOnButtonClick: true,
            timeout: 5000,
            templateResult: '#{text}',
            templateOptionsList: '#{text}',
            ...
            events: $H({
                onGetNewXml: 'EWS:sendDocEmpGetNewXml',
                onResultSelected: 'EWS:sendDocEmpSelected'
            })
        }, json);
    ...
    run: function($super, args) {
        ...
        this.emp = (selectedEmp && selectedEmp[0]) ? selectedEmp[0] : args.get("emp");
