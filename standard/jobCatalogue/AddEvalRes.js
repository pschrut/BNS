/** 
* @fileOverview AddEvalRes.js 
* @description File containing class AddEvalRes. 
* Application for Job Catalogue in OM - Edit Additional Data - Add Evaluation Results.
*/

/**
*@constructor
*@description Class AddEvalRes.
*@augments getContentDisplayer 
*/
var AddEvalRes = Class.create(getContentDisplayer, {
