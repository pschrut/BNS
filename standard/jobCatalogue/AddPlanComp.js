/** 
* @fileOverview AddPlanComp.js 
* @description File containing class AddPlanComp. 
* Application for Job Catalogue in OM - Edit Additional Data - Add Planned Compensation.
*/
...
*/
var AddPlanComp = Class.create(getContentDisplayer, {
