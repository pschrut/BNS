/** 
* @fileOverview changeAssignJobFam.js 
* @description File containing class changeAssignJobFam. 
* Application for Job Catalogue in OM.
*/

/**
*@constructor
*@description Class changeAssignJobFam.
*@augments getContentDisplayer 
*/
var changeAssignJobFam = Class.create(getContentDisplayer, {
    ...
    _actionButtonPressed: function(event) {
        ...
        switch (this.action) {
            ...
            case 'REC_OM_SAVE': // save row
                ...
                break;
            case 'SCR_OM_CREATE': // create (show the empty screen for create)
                //get view
