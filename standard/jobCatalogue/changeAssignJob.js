/** 
* @fileOverview changeAssignJob.js 
* @description File containing class changeAssignJob. 
* Application for Job Catalogue in OM.
*/

/**
*@constructor
*@description Class changeAssignJob.
*@augments getContentDisplayer 
*/
var changeAssignJob = Class.create(getContentDisplayer, {
