 ...
 */
var OM_MassTrans_standard = Class.create(Application,
/** 
...
getSubtypes: function(json) {
    //get the information
    this.subtypesNodes = json.EWS.o_subtypes.yglui_tab_subtypes;
    this.numberOfSubtypesNodes = json.EWS.o_subtypes.yglui_tab_subtypes.length;
    ...
    for (var i = 0; i < this.numberOfSubtypesNodes; i++) {
        subtypeName = this.subtypesNodes[i]["@stext"];
        subtypeId = this.subtypesNodes[i]["@subtype_code"];
    ...
    divTitle.insert("<acronym title=" + global.getLabel('title') + ">" + global.getLabel('title') + "</acronym>");
    ...
    //create html elements
    th = new Element('th', {
        className: 'OM_MassTrans_widthLabels table_nosort OM_massTransWidthTitle2AbbrNotes'
    });
    check = new Element('input', {
        id: 'OM_MassTrans_checkAllButton_TitleType',
        type: 'checkbox',
        row: '0',
        col: '1',
        className: 'OM_MassTrans_checkButton'
    ...
    divTitle = new Element('div', {
        id: 'OM_MassTrans_titleTypeHeader'
    }).insert("<acronym title=" + global.getLabel('title') + ">" + global.getLabel('title') + "</acronym>");
    //insert the elements
    ...
    table.insert(thead);
    //add the checkbox in the array
    this.arrayCheckboxes[0][1] = check;
    //THIRD COLUMN IN HEADER
    //create html elements
    th = new Element('th', {
        className: 'OM_MassTrans_widthLabels table_nosort OM_massTransWidthTitle2AbbrNotes'
    });
    ...
    divTitle = new Element('div', {
        id: 'OM_MassTrans_checkAllButton_AbrevType'
    }).insert("<acronym title=" + global.getLabel('abbr').gsub(' ', '&nbsp;') + ">" + global.getLabel('abbr').gsub(' ', '&nbsp;') + "</acronym>");
    //insert the elements
    var span = new Element('span', {
        'style': 'white-space: nowrap;'
    });
    ...
    table.insert(thead);
    //add the checkbox in the array
    this.arrayCheckboxes[0][2] = check;
...
fillFirstTable: function(jsonObject) {
    ...
    for (var i = 0; i < this.numberOfNodes; i++) {
        ...
        td = new Element('td');
        div = new Element('div', {
            id: 'OM_MassTrans_titleType',
            className: 'OM_MassTrans_widthLabels'
        });
        check = new Element('input', {
            id: 'OM_MassTrans_checkButton_' + idObj + '_STEXT',
            type: 'checkbox',
            row: row,
            col: '1',
            className: 'OM_MassTrans_checkButton'
        ...
        tr.insert(td);
        //add the checkbox in the array
        this.arrayCheckboxes[row][1] = check;
        //third column
        td = new Element('td');
        div = new Element('div', {
            id: 'OM_MassTrans_abrevType',
            className: 'OM_MassTrans_widthLabels'
        });
        check = new Element('input', {
            id: 'OM_MassTrans_checkButton_' + idObj + '_SHORT',
            type: 'checkbox',
            row: row,
            col: '2',
            className: 'OM_MassTrans_checkButton'
        ...
        tr.insert(td);
        //add the checkbox in the array
        this.arrayCheckboxes[row][2] = check;
...
/*
* @method close
* @desc Stops OM_MassTrans_standard
*/
...
var OM_MassTrans = Class.create(OM_MassTrans_standard, {
