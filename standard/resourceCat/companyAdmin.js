var companyAdmin=Class.create(getContentDisplayer,{
    ...
    */
    run: function($super,args) {
        ...
        var buttonsHandlers=$H({
            APP_LSOSAVEU: function() { this.saveRequest('APP_LSOSAVEU') } .bind(this),
            cancel: function() {
    ...
    */    
    setTitle: function(){
        var label;
        if(this.mode == 'edit')
            label = global.getLabel('maintCOM');
        else if (this.mode == 'create')
            label = global.getLabel('createCOM');
        else if (this.mode == 'display')        
            label = global.getLabel('displayCOM');        
