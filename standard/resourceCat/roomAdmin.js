var roomAdmin =Class.create(getContentDisplayer,{
    ...
    */
    run: function($super,args) {
        ...
        var buttonsHandlers=$H({
            APP_LSOSAVEG: function() { this.saveRequest('APP_LSOSAVEG') } .bind(this),            
            cancel: function() {
    ...
    */    
    setTitle: function(){
        var label;
        if(this.mode == 'edit')
            label = global.getLabel('maintR');
        else if (this.mode == 'create')
            label = global.getLabel('createR');
        else if (this.mode == 'display')        
            label = global.getLabel('displayR');        
