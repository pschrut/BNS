...
* Application for Learning - 'Remove Assignment' & 'Reassign' screen.
*/
...
*/
var relatUAdmin = Class.create(getContentDisplayer, {
    ...
    */
    run: function($super, args) {
        ...
        var buttonsHandlers = $H({
            APP_LSOSAVERELATU: function() { this.action = 'APP_LSOSAVERELATU', this.okContent(); } .bind(this)
        });
    ...
    processContent: function(answer) {
        if (this.okCode == 'NEW') {
            ...
            //this.jsonAssign = deepCopy(answer);
            this.okCode = '';
            //draw title
            var label = global.getLabel('reassignU');
