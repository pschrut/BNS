/** 
* @fileOverview resCatLocation.js 
* @description File containing class resCatLocation. 
* Application for Resource Catalogue.
*/

/**
*@constructor
*@description Class resCatLocation.
*/
var resCatLocation = Class.create(GenericCatalog, {
    ...
    */
    initialize: function($super, options) {
        $super(options, {
            ...
            applicationId: 'resCatLocation'  //applicationId: args.className
        });
    ...
    actionClicked: function(parameters) {
        ...
        switch (name) {
            case "LSOCREATEF": // show courses
                ...
                break;
            case "LSODELETEF": // show courses

                this.genericDelete('F', nodeId, name, nextApp, global.getLabel('delete_resourceInfo'), okCode);
                balloon.hide();
                break;
            case "LSODISPLAYF": // show courses
                ...
                break;
            case "LSOMAINTAINF": // show courses
