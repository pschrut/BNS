var teacherAdmin=Class.create(getContentDisplayer,{
    ...
    */
    run: function($super,args) {
        ...
        var buttonsHandlers=$H({
            APP_LSOSAVEH: function() { this.saveRequest('APP_LSOSAVEH') } .bind(this),
            cancel: function() {
    ...
    */    
    setTitle: function(){
        var label;
        if(this.mode == 'edit')
            label = global.getLabel('maintH');
        else if (this.mode == 'create')
            label = global.getLabel('createH');
        else if (this.mode == 'display')        
            label = global.getLabel('displayH');        
