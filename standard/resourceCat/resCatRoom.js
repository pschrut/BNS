/** 
* @fileOverview resCatRoom.js 
* @description File containing class resCatRoom. 
* Application for Resource Catalogue.
*/

/**
*@constructor
*@description Class resCatRoom.
*/
var resCatRoom=Class.create(GenericCatalog,{
    ...
    */
    initialize: function($super,options) {
        $super(options,{
            ...
            applicationId: 'resCatRoom'  //applicationId: args.className
        });
    ...
    actionClicked: function(parameters) {
        ...
        switch(name) {
            ...
            case "LSODISPLAYG": 
                ...
                break;  
            case "LSODELETEG": //delete a course group 
                this.genericDelete('G', nodeId, name, nextApp, global.getLabel('delete_resourceInfo'), okCode);
                balloon.hide();
                break;                                                          
            default:                
                balloon.hide();
