 ...
 */
{
	...
	clickingOnButton:function(){
		...
		if(customer){
			window.location = this.location + "?customer=" + customer;
		}else{
    ...
    roleTaken: function(man){   
        ...
        if(!Object.isEmpty(manager.idAdded)){ 
            if((this.element) && (manager.idAutocompleter == this.element.identify())){
            	if(customer){
            		window.location = this.location + "?customer=" + customer + "&roleOf=" + manager.idAdded;
            	}else{
            		window.location = this.location + "?roleOf=" + manager.idAdded;
            	}
            }
        }    
    }
