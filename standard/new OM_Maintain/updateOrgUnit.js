/** 
* @fileOverview updateOrgUnit.js 
* @description File containing class updateOrgUnit. 
* Application for Maintain in OM.
*/

/**
*@constructor
*@description Class updateOrgUnit_standard.
*@augments getContentDisplayer 
*/
var UpdateOrgUnit = Class.create(getContentDisplayer, {
