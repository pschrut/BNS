/** 
* @fileOverview newSuccessor.js 
* @description File containing class newSuccessor. 
* Application for Maintain in OM - Creating assignment from 'change Successor' screen.
*/

/**
*@constructor
*@description Class newSuccessor.
*@augments getContentDisplayer 
*/
var AssignSuccNew = Class.create(getContentDisplayer, {
