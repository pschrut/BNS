/** 
* @fileOverview assignSuccessor.js 
* @description File containing class assignSuccessor. 
* Application for Maintain in OM - Assign Successor
*/

/**
*@constructor
*@description Class assignSuccessor.
*@augments getContentDisplayer 
*/
var AssignSucc = Class.create(getContentDisplayer, {
