/** 
* @fileOverview changeAssignOrg.js 
* @description File containing class changeAssignOrg. 
* Application for Maintain in OM.
*/

/**
*@constructor
*@description Class changeAssignOrg.
*@augments getContentDisplayer 
*/
var changeAssignOrg = Class.create(getContentDisplayer, {
