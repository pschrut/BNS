/** 
* @fileOverview assignHolderAddOcc.js 
* @description File containing class assignHolderAddOcc. 
* Application for Maintain and Display in OM - Creating Additional Occupancy from 'Manage Holder Assign' screen.
*/

/**
*@constructor
*@description Class assignHolderAddOcc_standard.
*@augments getContentDisplayer 
*/
var AssignHolderAddOcc = Class.create(getContentDisplayer, {
