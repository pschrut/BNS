/** 
* @fileOverview createPosition.js 
* @description File containing class createPosition. 
* Application for Maintain in OM.
*/

/**
*@constructor
*@description Class createPosition
*@augments getContentDisplayer 
*/
var CreatePosition = Class.create(getContentDisplayer, {
    ...
    */
    saveScreen: function(action) {
        ...
        this.saveRequestService = 'SAVE_MULTI_POS';
        //save information
